...
![](images/orga.png){.stretch}

## Wifi

![](images/wifi.jpg){.stretch}
...
-   **change the system instead of your workload**
    ...
    -   student assistance
    -   students feedback the code from each other
...
[https://otter.uni-frankfurt.de/](https://otter.uni-frankfurt.de/)
...
- **Group: 5 Whys** (5 min)
  ...
  - The "problem-giver" explains the problem in one sentence
  - The group asks 5 times **Why?**
  - e.g., "I have the problem X" 
    - "Why do you have the problem X?" 
    - "Because of Y" 
    - "Why do you do Y?"
    - ...
  

- **Alone: Make the problem worse** (3 min)
  - What could be done to make the problem worse?
...
- **15% solutions** (20 mins)
  ...
  - **What can you already do without additional resources or external influences?**
